...
class Illnesskk extends MyController
{
    function Illnesskk()
    {
        parent::MyController();
    ...
    function index()
    {
        ...
        $this->load->view("/illness/illnesskk", $data);
        }
        else {
...
////            }
////            else {$hfilter = $hfilter . " and h.end_date >= CURRENT_DATE";}
    ...
    <ol>
        ...
        <li><a href="/illnesskk/download/<?php echo $p['id']; ?>"><?php echo $p['name']; ?></a></li>
        <?php endforeach; ?>
    </ol>
    <?php
