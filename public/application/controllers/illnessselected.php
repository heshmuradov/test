...
class Illnessselected extends MyController
{
    function Illnessselected()
    {
        parent::MyController();
    }
    ...
    function index()
    {
        if ($this->session->userdata['admin_type'] != 5) {
            ...
            $this->load->view("/illness/illnessselected", $data);
        } else {
    ...
    <ol>
        ...
        <li><a href="/illnessselected/download/<?php echo $p['id']; ?>"><?php echo $p['name']; ?></a></li>
        <?php endforeach; ?>
    </ol>
    <?php
