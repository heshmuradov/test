...
class Illnessrtgroup extends MyController
{
    function Illnessrtgroup()
    {
        parent::MyController();
    }
    ...
    function index()
    {
        if ($this->session->userdata['admin_type'] != 5) {
            ...
            $data['mkb10'] = $this->db->query('select t.row_num,t.r from spr_illness_10 t where t.r_level in (3,4,5) order by row_num')->result();
            ...
            $this->load->view("/illness/illnessrtgroup", $data);
        } else {
    ...
    function search()
    {
        ...
        try {
           ...
           // print_r($_POST['fmkb10']);exit;
            ...
            $codeill10 = isset($_POST['fcode_ill_10_par']) ? $_POST['fcode_ill_10_par'] : null;
            $mkb10 = isset($_POST['fmkb_10']) ? $_POST['fmkb_10'] : null;
            ...
            if (!empty($mkb10)){
                $hfilter = $hfilter." and h.mkb_10=$mkb10";
            }elseif(!empty($codeill10)){
                $hfilter = $hfilter." and h.mkb_10 in (select row_num from spr_illness_10 where r_level in (3,4,5) and group_id=$codeill10)";
            }
            ...
            if (!empty($guruh)) {
                ...
                $hfilter=$hfilter."and h.guruh in (1,2,3)";
            }
    ...
    <ol>
        ...
        <li><a href="/illnessgroup/download/<?php echo $p['id']; ?>"><?php echo $p['name']; ?></a></li>
        <?php endforeach; ?>
    </ol>
    <?php
    ...
    function search_excel()
    {
        ...
        else {$hfilter=$hfilter."and h.guruh in (1,2,3)";}
