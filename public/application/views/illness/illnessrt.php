...
$(function () {
    var mygrid = $('#list').jqGrid({
        ...
        colModel:[
            ...
            {name:'infl', index:'infl', width:15, editable:true, edittype:'text', editrules:{edithidden:true, custom:true, custom_func:pinflcheck}},
        ...
        onSelectRow:function (ids) {
            ...
            if (ids == null) {
                ...
                jQuery("#wwork").jqGrid('setGridParam', {url:"/illnessrt/work/" + ids, page:1});
                jQuery("#wwork").trigger('reloadGrid');

                jQuery("#murojaat").jqGrid('setGridParam', {url:"/illnessrt/murojaat/" + ids, page:1});
                jQuery("#murojaat").trigger('reloadGrid');

                jQuery("#history").jqGrid('setGridParam', {url:"/illnessrt/history/" + ids, page:1});
    ...
    $('#history').jqGrid({
        ...
        subGridRowExpanded:function (subgridid, id) {
            ...
            $("#" + jQuery.jgrid.jqID(subgridid)).load('/illnessrt/history_detail', data);
        }
    });
...
<form id="illnesssearch-form" action="/illnessrt/search_excel" method="POST">
<div id="accordion">
