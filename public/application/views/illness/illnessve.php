...
$(function () {
    var mygrid = $('#list').jqGrid({
        ...
        viewrecords:true,
        pager:'#pager',
        caption:'Вафот этган ногиронлар рўйхати',
        autowidth:true,
        onSelectRow:function (ids) {
            ...
            if (ids == null) {
                ...
                jQuery("#wwork").jqGrid('setGridParam', {url:"/illnessve/work/" + ids, page:1});
                jQuery("#wwork").trigger('reloadGrid');

                jQuery("#murojaat").jqGrid('setGridParam', {url:"/illnessve/murojaat/" + ids, page:1});
                jQuery("#murojaat").trigger('reloadGrid');

                jQuery("#history").jqGrid('setGridParam', {url:"/illnessve/history/" + ids, page:1});
    ...
    $('#history').jqGrid({
        ...
        subGridRowExpanded:function (subgridid, id) {
            ...
            $("#" + jQuery.jgrid.jqID(subgridid)).load('/illnessve/history_detail', data);
        }
    });
...
<form id="illnesssearch-form" action="/illnessve/search_excel" method="POST">
<div id="accordion">
...
<div>
    <table border="0" width="100%">
        ...
        <TR>
            <TD>
                <label style="display:block; ">Вафот этган муддати:</label>
            </TD>
            <TD>
            ...
            <TD>
                ...
                <input style="margin-bottom:12px;  padding: .3em; display:block;" type="text"
                       name="ftrdate_gacha" id="ftrdate_gacha" value=""
                       class="text ui-widget-content ui-corner-all">
            </TD>
        </TR>
    </table>
