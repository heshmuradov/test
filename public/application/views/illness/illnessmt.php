...
$(function () {
    var mygrid = $('#list').jqGrid({
        ...
        onSelectRow:function (ids) {
            ...
            if (ids == null) {
                ...
                jQuery("#wwork").jqGrid('setGridParam', {url:"/illnessmt/work/" + ids, page:1});
                jQuery("#wwork").trigger('reloadGrid');

                jQuery("#murojaat").jqGrid('setGridParam', {url:"/illnessmt/murojaat/" + ids, page:1});
                jQuery("#murojaat").trigger('reloadGrid');

                jQuery("#history").jqGrid('setGridParam', {url:"/illnessmt/history/" + ids, page:1});
    ...
    $('#history').jqGrid({
        ...
        subGridRowExpanded:function (subgridid, id) {
            ...
            $("#" + jQuery.jgrid.jqID(subgridid)).load('/illnessmt/history_detail', data);
        }
    });
...
<form id="illnesssearch-form" action="/illnessmt/search_excel" method="POST">
<div id="accordion">
