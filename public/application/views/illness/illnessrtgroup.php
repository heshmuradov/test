...
$(function () {
    var mygrid = $('#list').jqGrid({
        ...
        viewrecords:true,
        pager:'#pager',
        caption:'Рўйхатда турувчи гуруҳ белгиланган ногиронлар рўйхати',
        autowidth:true,
        onSelectRow:function (ids) {
            ...
            if (ids == null) {
                ...
                jQuery("#wwork").jqGrid('setGridParam', {url:"/illnessrtgroup/work/" + ids, page:1});
                jQuery("#wwork").trigger('reloadGrid');

                jQuery("#murojaat").jqGrid('setGridParam', {url:"/illnessrtgroup/murojaat/" + ids, page:1});
                jQuery("#murojaat").trigger('reloadGrid');

                jQuery("#history").jqGrid('setGridParam', {url:"/illnessrtgroup/history/" + ids, page:1});
    ...
    $('#history').jqGrid({
        ...
        subGridRowExpanded:function (subgridid, id) {
            ...
            $("#" + jQuery.jgrid.jqID(subgridid)).load('/illnessrtgroup/history_detail', data);
        }
    });
...
<form id="illnesssearch-form" action="/illnessrtgroup/search_excel" method="POST">
<div id="accordion">
    ...
    <table border="0" width="100%">
        ...
        <TR>
            ...
            <TD style="width: 300px;">
                ...
                <select style="margin-bottom:10px; width:70%; padding: .4em; display:block;"
                        name="fcode_ill_10_par" id="code_ill_10_par"
                        class="text ui-widget-content ui-corner-all code-ill">
                    <option value="">Белгиланмади</option>
