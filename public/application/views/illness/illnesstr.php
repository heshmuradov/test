...
$(function () {
    var mygrid = $('#list').jqGrid({
        ...
        viewrecords:true,
        pager:'#pager',
        caption:'Тўлиқ реабилитиция бўлган ногиронларнинг тўлиқ рўйхати',
        autowidth:true,
        onSelectRow:function (ids) {
            ...
            if (ids == null) {
                ...
                jQuery("#wwork").jqGrid('setGridParam', {url:"/illnesstr/work/" + ids, page:1});
                jQuery("#wwork").trigger('reloadGrid');

                jQuery("#murojaat").jqGrid('setGridParam', {url:"/illnesstr/murojaat/" + ids, page:1});
                jQuery("#murojaat").trigger('reloadGrid');

                jQuery("#history").jqGrid('setGridParam', {url:"/illnesstr/history/" + ids, page:1});
    ...
    $('#history').jqGrid({
        ...
        subGridRowExpanded:function (subgridid, id) {
            ...
            $("#" + jQuery.jgrid.jqID(subgridid)).load('/illnesstr/history_detail', data);
        }
    });
...
<form id="illnesssearch-form" action="/illnesstr/search_excel" method="POST">
<div id="accordion">
...
<div>
    <table border="0" width="100%">
        ...
        <TR>
            <TD>
                <label style="display:block; ">Тўлиқ реабилитация бўлган муддат:</label>
            </TD>
            <TD>
                <label style="display:block; ">дан:</label>
                <input style="margin-bottom:12px;  padding: .3em; display:block;" type="text"
                       name="ftrdate" id="ftrdate" value="" class="text ui-widget-content ui-corner-all">

            </TD>
            <TD>
                <label style="display:block; ">гача:</label>
                <input style="margin-bottom:12px;  padding: .3em; display:block;" type="text"
                       name="ftrdate_gacha" id="ftrdate_gacha" value="" class="text ui-widget-content ui-corner-all">
            </TD>
        </TR>
        <TR>
            <TD>
