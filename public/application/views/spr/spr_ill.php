...
<script type="text/javascript">
    $(function () {
        var pager = $('#pager');
        $('#list').jqGrid({
            url:'/main/spr_json_ill',
            datatype:'json',
            mtype:'POST',
            colNames:['Рақами', 'МКБ-9', 'МКБ-10', 'Номланиши(ўзбек)', 'Номланиши(рус)'],
            colModel:[
                {name:'id', index:'id', width:80},
                {name:'code_9', index:'code_9', width:80, editable:true, edittype:'text'},
                {name:'code_10', index:'code_10', width:80, editable:true, edittype:'text'},
            ...
            viewrecords:true,
            sortorder:"asc",
            editurl:"edit_illness",
            height:210,
            pager:'#pager',
            caption:'Касалликларни бошқариш маълумотномаси',
            autowidth:true
        });
