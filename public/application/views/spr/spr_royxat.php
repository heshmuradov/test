...
<script type="text/javascript">
    $(function () {
        var pager = $('#pager');
        $('#list').jqGrid({
            url:'/main/spr_json_royxat',
            datatype:'json',
            mtype:'POST',
            colNames:['Рақами', 'Номланиши(ўзбек)', 'Номланиши(рус)'],
            colModel:[
                {name:'id', index:'id', width:20, sorttype:'int'},
                {name:'name_uz', index:'name_uz', width:50, editable:true, edittype:'text'},
                {name:'name_ru', index:'name_ru', width:50, editable:true, edittype:'text'}
            ],
            rowNum:10,
            rowList:[2, 10, 20, 30],
            sortname:'id',
            ...
            height:210,
            pager:'#pager',
            caption:'Рўйхатлар маълумотномаси',
            autowidth:true
