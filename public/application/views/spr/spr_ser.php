    ...
    $(function () {
        ...
        $('#list').jqGrid({
            ...
            colModel:[
                ...
                {name:'name_uz', index:'name_uz', width:150, editable:true, edittype:'text'}
            ],
            rowNum:100,
            rowList:[2, 10, 20, 30],
            sortname:'id',
            ...
            height:400,
            pager:'#pager',
            caption:'Справка сериялари маълумотномаси',
            autowidth:true,
            onSelectRow:function(ids){
                List_id = ids;
            }
        });
        jQuery("#list").jqGrid('navGrid', '#pager', {add:true, del:false, edit:false, search:false}),
        ...
        jQuery('#list').jqGrid('navButtonAdd', '#pager', {id:'pager_excel', caption:'Юклаш', title:'Excelга юклаш', onClickButton:function (e) {
            try {
                jQuery("#list").jqGrid('excelExport', {tag:'excel', url:'/obj/sprtoexcel'});
            } catch (e) {
