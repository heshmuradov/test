...
<script type="text/javascript">
    $(function () {
        var pager = $('#pager');
        $('#list').jqGrid({
            url:'/main/spr_json_krit',
            datatype:'json',
            mtype:'POST',
            colNames:['Рақами', 'Критерия номи(ўзбек)', 'Критерия номи(рус)'],
            colModel:[
                {name:'id', index:'id', width:20},
                {name:'k_name_uz', index:'k_name_uz', width:80, editable:true, edittype:'text'},
                {name:'k_name_ru', index:'k_name_ru', width:80, editable:true, edittype:'text'}
            ],
            rowNum:10,
            rowList:[2, 10, 20, 30],
            sortname:'id',
            ...
            height:210,
            pager:'#pager',
            caption:'Критериялар маълумотномаси',
            autowidth:true
        });
