...
<div id="asosiy">
    ...
    <div id="vback">
        ...
        <button id="create-0">Худудни танланг</button>
    </div>
</div>
<div id="b0">
    <form id="form-0" action="/stat/statreport" method="POST">
        <table>
            <BR/>
            <?php if ($is_mon) : ?>
            <TR>
                <TD>
                    <label style="display:block;">Вилоят номи:</label>
                    <select name="id_region" id="id_region" class="text ui-widget-content ui-corner-all">
                        <?php foreach ($region as $iddp) : ?>
