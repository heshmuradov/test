...
<table border="1" cellspacing="0" cellpadding="0">
  <tr height="24">
    <td colspan="19" height="24" width="1693" align="center"><?php echo $depart_name[0]->name_uz; ?>  бўйича 16 ёшдан катта ногиронлар  тўғрисида </td>
  </tr>
  <tr height="21">
    <td colspan="19" height="21" align="center"><strong>МАЪЛУМОТ</strong></td>
  </tr>
  <tr height="42">
  ...
  <tr height="80">
    ...
    <td width="100" align="center">Расмийлаштирилган сана</td>
  ...
  <tr height="31">
    ...
    <td width="101"><?php echo $re->rt; ?></td>
      ...
      <td width="101"><?php echo date('d.m.Y',strtotime($re->pdate)); ?></td>
  </tr>
<?php $i++; endforeach; ?>
 </table>
</body>
