        ...
        <CENTER>
            ...
            <table align="center" cellpadding="0" cellspacing="0" width="80%">
                ...
                <tr class="qator">
                    ...
                    <td class="first"> Дастлабки текшириш натижалари</td>
                </tr>
                <tr class="qator">
                    <td class="first">
                        <button id="create-2">2 - Бўлим</button>
                    </td>
                    <td class="first"> Барча ижтимоий тоифадагиларни биринчи маротаба кўрикдан ўтказиш натижалари</td>
                </tr>
                <tr class="qator">
                    <td class="first">
                        <button id="create-3">3 - Бўлим</button>
                    </td>
                    <td class="first"> Шаҳарда яшовчиларни биринчи маротаба кўрикдан ўтказиш натижалари</td>
                </tr>
                <tr class="qator">
                    <td class="first">
                        <button id="create-4">4 - Бўлим</button>
                    </td>
                    <td class="first"> Қишлоқда яшовчиларни биринчи маротаба кўрикдан ўтказиш натижалари</td>
                </tr>
                <tr class="qator">
                    <td class="first">
                        <button id="create-5">5 - Бўлим</button>
                    </td>
                    <td class="first"> Барча ижтимоий тоифалар орасида ишловчиларни биринчи маротаба кўрикдан ўтказиш
                        натижалари
                    </td>
                </tr>
                <tr class="qator">
                    ...
                    <td class="first"> Шаҳарда яшовчи шахслардан ишловчиларни биринчи маротаба кўрикдан ўтказиш
                        натижалари
                    </td>
                </tr>
                <tr class="qator">
                    ...
                    <td class="first"> Қишлоқда яшовчи шахслардан ишловчиларни биринчи маротаба кўрикдан ўтказиш
                        натижалари
                    </td>
                </tr>
                <tr class="qator">
...
<div id="b1" title="1 - бўлим  ҳисобот параметрларини танланг">
    <form id="form-1" action="/reports/b1report" method="POST">
        <table>
            <tr>
                <TD>
...
<div id="b2" title="2 - бўлим  ҳисобот параметрларини танланг">
    <form id="form-2" action="/resptmekstat/printtmekstat" method="POST">
      <table>
            <tr>
                <TD>
                    <label style="display:block;">Бошланғич сана:</label>
...
<div id="b3" title="3- бўлим  ҳисобот параметрларини танланг">
    <form id="form-3" action="/resptmekstat/printtmekstat" method="POST">
      <table>
            <tr>
                <TD>
                    <label style="display:block;">Бошланғич сана:</label>
...
<div id="b4" title="4- бўлим  ҳисобот параметрларини танланг">
    <form id="form-4" action="/resptmekstat/printtmekstat" method="POST">
      <table>
            <tr>
                <TD>
                    <label style="display:block;">Бошланғич сана:</label>
...
<div id="b5" title="5- бўлим  ҳисобот параметрларини танланг">
    <form id="form-5" action="/resptmekstat/printtmekstat" method="POST">
       <table>
            <tr>
                <TD>
                    <label style="display:block;">Бошланғич сана:</label>
...
<div id="b6" title="6- бўлим  ҳисобот параметрларини танланг">
    <form id="form-6" action="/resptmekstat/printtmekstat" method="POST">
      <table>
            <tr>
                <TD>
                    <label style="display:block;">Бошланғич сана:</label>
...
<div id="b7" title="7- бўлим  ҳисобот параметрларини танланг">
    <form id="form-7" action="/resptmekstat/printtmekstat" method="POST">
      <table>
            <tr>
                <TD>
                    <label style="display:block;">Бошланғич сана:</label>
